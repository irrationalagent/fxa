...
const QUERY_LIST_REFRESH_TOKENS_BY_UID =
  'SELECT refreshTokens.token AS refreshTokenId, refreshTokens.clientId, refreshTokens.lastUsedAt, ' +
...
const DELETE_REFRESH_TOKEN_WITH_CLIENT_AND_UID =
  'DELETE FROM refreshTokens WHERE token=? AND userId=? AND clientId=?';
